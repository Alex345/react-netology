...
1. [Страница интернет-магазина (функциональный компонент)](README_ShopItemFunc.md).
1. [Страница интернет-магазина (class-based компонент)](README_ShopItemClass.md).
1. [Календарь](README_Calendar.md) — необязательная задача со звёздочкой.
