...
1. [Портфолио с фильтрами](README-Portfolio.md).
1. [Расположение товаров](README-StoreProductViews.md).
1. [Выпадающий список](README-Dropdown.md) — необязательная задача.
